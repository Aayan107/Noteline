...
$message .= "http://localhost/NOS/activate.php?email=" . urlencode($email) . "&key=$activationKey";
echo "\n$message";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'aayan1073@gmail.com')){
